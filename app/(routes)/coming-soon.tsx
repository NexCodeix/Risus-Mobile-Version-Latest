        ...
        <View className="flex-1 justify-center items-center px-10">
          ...
          <View className="items-center">
            ...
            <Text className="text-blue-200/70 text-lg text-center mt-8 leading-6 font-medium">
              We&apos;re building something amazing for you. Get ready for a
          ...
          <View className="px-8 pb-10">
            <TouchableOpacity
              activeOpacity={0.8}
              className="bg-[#3b82f6] flex-row items-center justify-center px-5 mt-5 py-5 rounded-3xl shadow-2xl shadow-blue-500/40"
            >
              <Ionicons
                name="notifications"
                size={22}
