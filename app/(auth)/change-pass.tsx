...
import { ChangePasswordSchema, ChangePasswordForm } from "@/validate/auth";
                        ...
                        <View className="flex-1 items-center justify-center">
                            ...
                            >
                                <BlurView intensity={100} tint="light" className="p-8 bg-white/40">
                                    <Text className="text-3xl font-bold text-slate-800 text-center">Change Password</Text>
                                    <Text className="text-slate-500 text-center mt-2 mb-8 font-medium">Please enter your new password details.</Text>
